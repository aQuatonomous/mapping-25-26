...
#ifndef POINTCLOUD_FILTERS__SRV__DETAIL__GET_CLOUD_WINDOW__FUNCTIONS_H_
#define POINTCLOUD_FILTERS__SRV__DETAIL__GET_CLOUD_WINDOW__FUNCTIONS_H_
...
/// Initialize srv/GetCloudWindow message.
/**
...
/// Finalize srv/GetCloudWindow message.
/**
...
/// Create srv/GetCloudWindow message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pointcloud_filters__srv__GetCloudWindow_Request__init().
...
/// Destroy srv/GetCloudWindow message.
/**
 * It calls
 * pointcloud_filters__srv__GetCloudWindow_Request__fini()
...
/// Check for srv/GetCloudWindow message equality.
/**
...
/// Copy a srv/GetCloudWindow message.
/**
...
/// Initialize array of srv/GetCloudWindow messages.
/**
...
/// Finalize array of srv/GetCloudWindow messages.
/**
 * It calls
 * pointcloud_filters__srv__GetCloudWindow_Request__fini()
...
/// Create array of srv/GetCloudWindow messages.
/**
 * It allocates the memory for the array and calls
 * pointcloud_filters__srv__GetCloudWindow_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetCloudWindow messages.
/**
 * It calls
 * pointcloud_filters__srv__GetCloudWindow_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetCloudWindow message array equality.
/**
...
/// Copy an array of srv/GetCloudWindow messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pointcloud_filters__srv__GetCloudWindow_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pointcloud_filters
...
/**
 * It calls
 * pointcloud_filters__srv__GetCloudWindow_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pointcloud_filters
...
/**
 * It allocates the memory for the array and calls
 * pointcloud_filters__srv__GetCloudWindow_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pointcloud_filters
...
/**
 * It calls
 * pointcloud_filters__srv__GetCloudWindow_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // POINTCLOUD_FILTERS__SRV__DETAIL__GET_CLOUD_WINDOW__FUNCTIONS_H_
