...
#include "pointcloud_filters/msg/detail/tracked_buoy__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedBuoy__ros_msg_type = pointcloud_filters__msg__TrackedBuoy;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackedBuoy__ros_msg_type * ros_message = static_cast<const _TrackedBuoy__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _TrackedBuoy__ros_msg_type * ros_message = static_cast<_TrackedBuoy__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _TrackedBuoy__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pointcloud_filters__msg__TrackedBuoy(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pointcloud_filters__msg__TrackedBuoy;
    is_plain =
      (
...
static size_t _TrackedBuoy__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pointcloud_filters__msg__TrackedBuoy(
...
static message_type_support_callbacks_t __callbacks_TrackedBuoy = {
...
static rosidl_message_type_support_t _TrackedBuoy__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackedBuoy,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pointcloud_filters, msg, TrackedBuoy)() {
  return &_TrackedBuoy__type_support;
}
