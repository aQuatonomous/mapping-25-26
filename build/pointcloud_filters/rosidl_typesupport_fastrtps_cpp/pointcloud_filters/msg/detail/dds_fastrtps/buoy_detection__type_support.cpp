...
#include "pointcloud_filters/msg/detail/buoy_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pointcloud_filters::msg::BuoyDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pointcloud_filters::msg::BuoyDetection & ros_message)
{
  // Member: range
  cdr >> ros_message.range;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pointcloud_filters::msg::BuoyDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pointcloud_filters::msg::BuoyDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pointcloud_filters::msg::BuoyDetection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BuoyDetection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pointcloud_filters::msg::BuoyDetection *>(
...
static size_t _BuoyDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BuoyDetection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BuoyDetection__callbacks = {
...
static rosidl_message_type_support_t _BuoyDetection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BuoyDetection__callbacks,
...
{
  return &pointcloud_filters::msg::typesupport_fastrtps_cpp::_BuoyDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pointcloud_filters, msg, BuoyDetection)() {
  return &pointcloud_filters::msg::typesupport_fastrtps_cpp::_BuoyDetection__handle;
}
